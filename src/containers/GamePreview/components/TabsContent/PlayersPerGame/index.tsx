...
import { getPlayersPerGameAction } from 'containers/GamePreview/store/PlayersPerGame/actions';
import {
  getPlayersPerGame,
  getPlayersPerGameError,
  getPlayersPerGameLoading,
} from 'common/selectors/GamePreview/playersPerGame';
import PlayersPerGameTable from 'containers/GamePreview/components/TabsContent/PlayersPerGame/PlayersPerGameTable';
